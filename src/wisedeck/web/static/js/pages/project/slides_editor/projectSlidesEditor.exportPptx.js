            ...
            try {
                ...
                try {
                    ...
                    const fetchScripts = async (lang) => {
                        try {
                            const resp = await fetch(`/api/projects/${window.wisedeckEditorConfig.projectId}/speech-scripts?language=${encodeURIComponent(lang)}`, {
                ...
                const projectTitleRaw = window.wisedeckEditorConfig.exportTitle || 'presentation';
