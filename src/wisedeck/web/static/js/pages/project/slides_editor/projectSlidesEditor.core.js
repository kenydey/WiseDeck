window.wisedeckEditorConfig = JSON.parse(
    document.getElementById('projectEditorConfigScript').textContent
);
window.landpptEditorProjectInfo = window.wisedeckEditorConfig.projectInfo || { title: '', topic: '', scenario: '' };
window.landpptEditorProjectRequirements = window.wisedeckEditorConfig.projectRequirements || '';
...
const narrationVideoToolsEnabled = !!window.wisedeckEditorConfig.narrationVideoToolsEnabled;
