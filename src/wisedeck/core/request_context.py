"""
Request-scoped context for per-user isolation and base URL resolution.

This module is intentionally lightweight and contains no FastAPI/DB imports.
"""
...
# The current effective user's ID for the active request/task.
current_user_id: ContextVar[Optional[int]] = ContextVar("wisedeck_current_user_id", default=None)

# The current request's externally reachable base URL, when available.
current_base_url: ContextVar[Optional[str]] = ContextVar("wisedeck_current_base_url", default=None)
