...
class PlaywrightPDFConverter:
    ...
    async def _wait_for_animations_complete(self, page: Page, timeout_ms: int = 10000) -> None:
        ...
        settle_ms = int(os.environ.get("WISEDECK_ANIMATION_SETTLE_MS", "0"))
    ...
    async def _preheat_animations(self, page: Page, duration_ms: int = 3000) -> None:
        ...
        """
        preheat_duration = int(os.environ.get("WISEDECK_VIDEO_PREHEAT_DURATION_MS", str(duration_ms)))
    ...
    async def record_html_video(
        ...
        *,
        ...
        try:
            ...
            try:
                max_retries = int(os.environ.get("WISEDECK_RECORD_VERIFY_RETRIES", "3") or 3)
            ...
            trim_leadin_ms = 120
            try:
                trim_leadin_ms = int(os.environ.get("WISEDECK_RECORD_TRIM_LEADIN_MS", "120") or 120)
            except Exception:
                trim_leadin_ms = 120
