...
from wisedeck.services.structured_export._presenton.html_to_text_runs_service import (
...
from wisedeck.services.structured_export._presenton.asset_directory_utils import (
    get_images_directory,
    resolve_image_path_to_filesystem,
)
from wisedeck.services.structured_export._presenton.download_helpers import download_files
from wisedeck.services.structured_export._presenton.app_data_env import get_app_data_directory_env
from wisedeck.services.structured_export._presenton.image_utils import (
    clip_image,
    create_circle_image,
    fit_image,
    invert_image,
...
class PptxPresentationCreator:
    ...
    def add_chart(self, slide: Slide, chart_model: PptxChartBoxModel):
        ...
        if chart_type == "bar":
            ...
            pptx_chart_type = getattr(XL_CHART_TYPE, "DOUGHNUT", XL_CHART_TYPE.PIE)
        elif chart_type == "area":
            pptx_chart_type = getattr(XL_CHART_TYPE, "AREA", XL_CHART_TYPE.LINE_MARKERS)
