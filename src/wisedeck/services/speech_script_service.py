...
class SpeechScriptService:
    ...
    async def _initialize_ai_provider_async(self):
        ...
        try:
            ...
            # WiseDeck requires system credentials; only try if configured.
            if system_config.get("wisedeck_api_key") and "wisedeck" not in candidates:
                candidates.append("wisedeck")
