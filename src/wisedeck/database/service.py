...
class DatabaseService:
    ...
    def _convert_db_project_to_api(self, db_project: DBProject) -> PPTProject:
        ...
        return PPTProject(
            ...
            design_spec=getattr(db_project, "design_spec", None),
            design_spec_version=int(getattr(db_project, "design_spec_version", 1) or 1),
            design_spec_locked=bool(getattr(db_project, "design_spec_locked", False)),
